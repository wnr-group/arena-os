...
import { X, UtensilsCrossed, Minus, Plus, Loader2, ShoppingBag, StickyNote } from 'lucide-react'
...
function CartDrawer({
  ...
  function handlePlaceOrder() {
    ...
    startTransition(async () => {
      ...
      clearCart()
      handleClose()
      toast.success(res.pendingAcceptance ? `Order #${res.orderNumber} received!` : `Order #${res.orderNumber} sent to the kitchen!`, {
        ...
        <div className="flex items-center justify-between gap-3 border-b border-border/70 bg-gradient-to-r from-primary/5 via-transparent to-transparent px-5 py-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-base font-black tracking-tight text-foreground">Your order</h2>

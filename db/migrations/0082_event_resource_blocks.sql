-- ============================================================================
-- Arena OS — 0082 event resource blocking (M15 #4)
--
...
--
-- The composite-FK pattern 0016/0018/0076 use. A plain `references
...
-- change it. The same split events itself uses (0076).

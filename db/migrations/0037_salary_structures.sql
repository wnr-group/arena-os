-- ============================================================================
-- Arena OS — 0037 salary_structures: base pay + allowances/deductions per
...
-- TaxBreakupLine on invoices (0014): amounts are numeric(10,2)-shaped strings,
-- never floats.
--
-- Compensation is the most sensitive per-person data in the system, more so
-- than the business's own legal identity (business_profiles, 0018) — so

-- ============================================================================
-- Arena OS — 0054 platform refunds (AROS-114)
--
...
--                     that has existed since 0050.
--   comp / discount → ALREADY MODELLED. 0052 built credit notes plus
...
--                              `platform_invoices_credit_note_unpaid` (0052)
...
create table if not exists public.platform_refunds (
  ...
  -- restrict, exactly like platform_invoices.subscription_id (0052): the bill a
  ...
  -- ── the gateway side ────────────────────────────────────────────────────
  --
  -- ARENA OS's Razorpay account, never a tenant's own (see 0051's header for
...
-- ── RLS + grants ────────────────────────────────────────────────────────────
--
-- Exactly the treatment platform_invoices got in 0052 and
-- platform_dunning_notices got in 0053, for the same reason: what a business

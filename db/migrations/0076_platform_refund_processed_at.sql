-- ============================================================================
-- Arena OS — 0076 when a platform refund actually processed
--
...
-- 0074's whole design is that reserving and processing are deliberately not the
-- same moment:
--
...
-- exactly where 0074 says it will: on a timeout or a 5xx the row is left
...
--
-- `updated_at` is maintained by trg_platform_refunds_updated (0074) on EVERY
...
-- else (0074); this column inherits exactly that, so a business can no more

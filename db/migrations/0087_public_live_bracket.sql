-- ============================================================================
-- Arena OS — 0087 public live bracket (M15 #7)
--
...
--
-- 0077 made two statuses public — `published` and `registration_open` — because
...
--
-- 0077's reasoning for putting the status test in the policy rather than only
...
--
-- `event_matches` (0086) holds registration ids, scores and a winner — nothing
...
-- public_event_taken_counts() already use (0079).
-- ============================================================================
...
-- participant or a match. `event_matches_manager_write` (0086) remains the only
...
--
-- 0086 already indexes (event_id, side, round, position), which is exactly the

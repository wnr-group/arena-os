-- ============================================================================
-- Arena OS — 0084 where a subscription's billing period came from
--
-- A correctness fix to the M16 lifecycle, not a new feature. One boolean.
--
-- ── THE BUG THIS CLOSES ─────────────────────────────────────────────────────
--
-- `tenant_subscriptions.current_period_start/end` are documented (0079, 0080)
...
-- period at creation time (the column is NOT NULL and 0079's
...
--
-- The replay protection 0079/0080 relied on is therefore not weakened for a
...
-- tenant_subscriptions (0079); this column inherits exactly that, so a business

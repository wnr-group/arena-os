-- ============================================================================
-- Arena OS — 0023 public booking creation: let a public (no-login) visitor on
-- app/(public)/book actually place a booking, pinned to app.public_tenant_id
-- exactly like the read-only policies in 0022_public_booking.sql.
-- ============================================================================
...
-- booking_slots' pricing columns in 0022: RLS is the tenant boundary: the

-- ============================================================================
-- Arena OS — 0092 paid event registrations through the EXISTING Razorpay
-- integration (M15 #3).
--
...
--
-- ── Split from 0091 for a hard Postgres reason ──────────────────────────────
--
...
-- goes last here and everything that names it lands in 0093. Same split, same
-- reason, as 0058 → 0059.
-- ============================================================================
...
-- see the header. 0093 is where it starts being used.

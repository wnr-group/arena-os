-- ============================================================================
-- Arena OS — 0071 platform subscription billing (Razorpay Subscriptions)
--
-- M16 #1 (0070) built the MODEL: `plans`, `plan_entitlements`,
-- `tenant_subscriptions`. M16 #2 built ENFORCEMENT. This migration builds the
-- part 0070 explicitly deferred — "checkout, gateway subscription creation,
...
--
-- `gateway` names which provider these ids belong to, matching the column 0070
...
--
-- `gateway` and `gateway_subscription_id` already exist (0070) and are REUSED
...
alter table public.tenant_subscriptions
  ...
  -- tenant_subscriptions_cancelled_at (0070) CHECKs that cancelled_at is set if
...
-- plans / tenant_subscriptions keep the policies and grants 0070 gave them:

-- ============================================================================
-- Arena OS — 0095 registration check-in token (M15 #5)
--
...
-- having to remember. A nullable column would leave "registered before 0095"
...
-- from 0091, and a new column inherits them exactly:
--

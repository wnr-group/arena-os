 ...
 *
 * REAL: the database and migration 0052 with all of its CHECK constraints (so a
...
async function main() {
  ...
  // across the whole catalogue (0050) and the gateway plan ids are unique too,
  ...
  let gwSubA = ''
  {
    ...
    // which migration 0052 checks in the database.
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    // Tag-unique: plans.name is globally unique (0050), so a fixed string here

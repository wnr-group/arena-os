...
/**
 * What the POLICY admits, widened by migration 0099 for the live bracket
...
async function main() {
  ...
  // the shape of the list, which 0099 legitimately widened.
  ...
  // keeps 0099 from quietly putting finished tournaments back in "what's on".

 ...
 * all CHECK constraints in migration 0088. validateEventFields() states the
 ...
 * valid. Mirrors the CHECK constraints in 0088 one-for-one.
 */
export function validateEventFields(v: {
  ...
  // The team rules, mirroring the events_team_size CHECK in migration 0091 one
...
/** Mirrors the events_team_size CHECK bounds in migration 0091. */

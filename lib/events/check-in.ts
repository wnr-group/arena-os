 ...
 *
 * The token is `event_registrations.check_in_token` (migration 0083), which is
 ...
 *
 * Promotion delegates to `promote_event_waitlist()` (0079), the same function
 ...
 *                      webhook (0080), so "has it been paid?" is already

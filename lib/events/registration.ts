 ...
 * ./registrations, and the real enforcement lives in migration 0091.
 *
 * Keep the unions in sync with the SQL enums, the way ./types mirrors 0088.
 */
 ...
 *
 * Two windows, both set inside migration 0091 and repeated here only so the UI

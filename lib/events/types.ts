/**
 * The event vocabulary, mirrored from the SQL enums in migration 0088.
 *
 ...
 *
 * It is mirrored by the events_public_select policy in migration 0089, which is
 ...
 * counts through public_event_taken_counts() (migration 0091), the manager
 ...
 *
 * For a TEAM event the unit is a team, not a player (see 0091's capacity note),
 ...
 */
/** What an event reserves for its window (M15 #4, migration 0094). */
 ...
 *
 * Capacity counts registrations (migration 0091), and a registration is one

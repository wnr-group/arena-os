...
export function proxy(request: NextRequest) {
  ...
  // Both exemptions are required and neither replaces the other: the public
  // booking site is reachable signed-out (incoming side), and gateway webhooks
  // carry no cookie at all (HEAD).
  const needsSession =

 ...
 * and available item, with photos and prices, and a cart/checkout (same
 * OrderCartProvider + OrderMenuClient as the QR-at-station flow, just
 * without a stationToken — orders placed here go through as pickup/takeaway,
 * see lib/actions/public-orders.ts). Tenant is resolved from the subdomain
          ...
          <section className="relative z-10 overflow-hidden bg-gradient-to-b from-primary/5 via-transparent to-transparent">
            <div className="relative mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-24">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl">
                Discover our carefully crafted culinary selection. Browse our items, add what you like, and check out.
              </p>
